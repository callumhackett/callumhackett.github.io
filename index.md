...
On the research landscape, you can find me at the intersection of [pragmatism](https://en.wikipedia.org/wiki/Pragmatism){:target="_blank"}, [enactivism](https://en.wikipedia.org/wiki/Enactivism){:target="_blank"} and [quietism](https://en.wikipedia.org/wiki/Quietism_(philosophy)){:target="_blank"}. For me, intelligence is an explanatory tool, not an algorithm, and what it explains is goal-directed behaviour, not mental abilities.
